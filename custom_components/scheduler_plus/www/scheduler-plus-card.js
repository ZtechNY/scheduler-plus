...
\f\r"'\`<>=]|("|')|))|$)`,"g"),$1=/'/g,N1=/"/g,U1=/^(?:script|style|textarea|title)$/i,k1=M=>(H,...C)=>({_$litType$:M,strings:H,values:C}),a=k1(1),E2=k1(2),$2=k1(3),k=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),W1=new WeakMap,w=F.createTreeWalker(F,129);function Q1(M,H){if(!f1(M)||!M.hasOwnProperty("raw"))throw Error("invalid template strings array");return D1!==void 0?D1.createHTML(H):H}var G1=(M,H)=>{let C=M.length-1,V=[],L,r=H===2?"<svg>":H===3?"<math>":"",e=z;for(let i=0;i<C;i++){let t=M[i],n,l,o=-1,x=0;for(;x<t.length&&(e.lastIndex=x,l=e.exec(t),l!==null);)x=e.lastIndex,e===z?l[1]==="!--"?e=_1:l[1]!==void 0?e=E1:l[2]!==void 0?(U1.test(l[2])&&(L=RegExp("</"+l[2],"g")),e=P):l[3]!==void 0&&(e=P):e===P?l[0]===">"?(e=L??z,o=-1):l[1]===void 0?o=-2:(o=e.lastIndex-l[2].length,n=l[1],e=l[3]===void 0?P:l[3]==='"'?N1:$1):e===N1||e===$1?e=P:e===_1||e===E1?e=z:(e=P,L=void 0);let v=e===P&&M[i+1].startsWith("/>")?" ":"";r+=e===z?t+S2:o>=0?(V.push(n),t.slice(0,o)+O1+t.slice(o)+f+v):t+f+(o===-2?i:v)}return[Q1(M,r+(M[C]||"<?>")+(H===2?"</svg>":H===3?"</math>":"")),V]},j=class M{constructor({strings:H,_$litType$:C},V){let L;this.parts=[];let r=0,e=0,i=H.length-1,t=this.parts,[n,l]=G1(H,C);if(this.el=M.createElement(n,V),w.currentNode=this.el.content,C===2||C===3){let o=this.el.content.firstChild;o.replaceWith(...o.childNodes)}for(;(L=w.nextNode())!==null&&t.length<i;){if(L.nodeType===1){if(L.hasAttributes())for(let o of L.getAttributeNames())if(o.endsWith(O1)){let x=l[e++],v=L.getAttribute(o).split(f),Z=/([.?@])?(.*)/.exec(x);t.push({type:1,index:r,name:Z[2],strings:v,ctor:Z[1]==="."?i1:Z[1]==="?"?A1:Z[1]==="@"?o1:D}),L.removeAttribute(o)}else o.startsWith(f)&&(t.push({type:6,index:r}),L.removeAttribute(o));if(U1.test(L.tagName)){let o=L.textContent.split(f),x=o.length-1;if(x>0){L.textContent=e1?e1.emptyScript:"";for(let v=0;v<x;v++)L.append(o[v],K()),w.nextNode(),t.push({type:2,index:++r});L.append(o[x],K())}}}else if(L.nodeType===8)if(L.data===g1)t.push({type:2,index:r});else{let o=-1;for(;(o=L.data.indexOf(f,o+1))!==-1;)t.push({type:7,index:r}),o+=f.length-1}r++}}static createElement(H,C){let V=F.createElement("template");return V.innerHTML=H,V}};function R(M,H,C=M,V){if(H===k)return H;let L=V!==void 0?C._$Co?.[V]:C._$Cl,r=q(H)?void 0:H._$litDirective$;return L?.constructor!==r&&(L?._$AO?.(!1),r===void 0?L=void 0:(L=new r(M),L._$AT(M,C,V)),V!==void 0?(C._$Co??=[])[V]=L:C._$Cl=L),L!==void 0&&(H=R(M,L._$AS(M,H.values),L,V)),H}var t1=class{constructor(H,C){this._$AV=[],this._$AN=void 0,this._$AD=H,this._$AM=C}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(H){let{el:{content:C},parts:V}=this._$AD,L=(H?.creationScope??F).importNode(C,!0);w.currentNode=L;let r=w.nextNode(),e=0,i=0,t=V[0];for(;t!==void 0;){if(e===t.index){let n;t.type===2?n=new $(r,r.nextSibling,this,H):t.type===1?n=new t.ctor(r,t.name,t.strings,this,H):t.type===6&&(n=new a1(r,this,H)),this._$AV.push(n),t=V[++i]}e!==t?.index&&(r=w.nextNode(),e++)}return w.currentNode=F,L}p(H){let C=0;for(let V of this._$AV)V!==void 0&&(V.strings!==void 0?(V._$AI(H,V,C),C+=V.strings.length-2):V._$AI(H[C])),C++}},$=class M{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(H,C,V,L){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=H,this._$AB=C,this._$AM=V,this.options=L,this._$Cv=L?.isConnected??!0}get parentNode(){let H=this._$AA.parentNode,C=this._$AM;return C!==void 0&&H?.nodeType===11&&(H=C.parentNode),H}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(H,C=this){H=R(this,H,C),q(H)?H===p||H==null||H===""?(this._$AH!==p&&this._$AR(),this._$AH=p):H!==this._$AH&&H!==k&&this._(H):H._$litType$!==void 0?this.$(H):H.nodeType!==void 0?this.T(H):I1(H)?this.k(H):this._(H)}O(H){return this._$AA.parentNode.insertBefore(H,this._$AB)}T(H){this._$AH!==H&&(this._$AR(),this._$AH=this.O(H))}_(H){this._$AH!==p&&q(this._$AH)?this._$AA.nextSibling.data=H:this.T(F.createTextNode(H)),this._$AH=H}$(H){let{values:C,_$litType$:V}=H,L=typeof V=="number"?this._$AC(H):(V.el===void 0&&(V.el=j.createElement(Q1(V.h,V.h[0]),this.options)),V);if(this._$AH?._$AD===L)this._$AH.p(C);else{let r=new t1(L,this),e=r.u(this.options);r.p(C),this.T(e),this._$AH=r}}_$AC(H){let C=W1.get(H.strings);return C===void 0&&W1.set(H.strings,C=new j(H)),C}k(H){f1(this._$AH)||(this._$AH=[],this._$AR());let C=this._$AH,V,L=0;for(let r of H)L===C.length?C.push(V=new M(this.O(K()),this.O(K()),this,this.options)):V=C[L],V._$AI(r),L++;L<C.length&&(this._$AR(V&&V._$AB.nextSibling,L),C.length=L)}_$AR(H=this._$AA.nextSibling,C){for(this._$AP?.(!1,!0,C);H!==this._$AB;){let V=R1(H).nextSibling;R1(H).remove(),H=V}}setConnected(H){this._$AM===void 0&&(this._$Cv=H,this._$AP?.(H))}},D=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(H,C,V,L,r){this.type=1,this._$AH=p,this._$AN=void 0,this.element=H,this.name=C,this._$AM=L,this.options=r,V.length>2||V[0]!==""||V[1]!==""?(this._$AH=Array(V.length-1).fill(new String),this.strings=V):this._$AH=p}_$AI(H,C=this,V,L){let r=this.strings,e=!1;if(r===void 0)H=R(this,H,C,0),e=!q(H)||H!==this._$AH&&H!==k,e&&(this._$AH=H);else{let i=H,t,n;for(H=r[0],t=0;t<r.length-1;t++)n=R(this,i[V+t],C,t),n===k&&(n=this._$AH[t]),e||=!q(n)||n!==this._$AH[t],n===p?H=p:H!==p&&(H+=(n??"")+r[t+1]),this._$AH[t]=n}e&&!L&&this.j(H)}j(H){H===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,H??"")}},i1=class extends D{constructor(){super(...arguments),this.type=3}j(H){this.element[this.name]=H===p?void 0:H}},A1=class extends D{constructor(){super(...arguments),this.type=4}j(H){this.element.toggleAttribute(this.name,!!H&&H!==p)}},o1=class extends D{constructor(H,C,V,L,r){super(H,C,V,L,r),this.type=5}_$AI(H,C=this){if((H=R(this,H,C,0)??p)===k)return;let V=this._$AH,L=H===p&&V!==p||H.capture!==V.capture||H.once!==V.once||H.passive!==V.passive,r=H!==p&&(V===p||L);L&&this.element.removeEventListener(this.name,this,V),r&&this.element.addEventListener(this.name,this,H),this._$AH=H}handleEvent(H){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,H):this._$AH.handleEvent(H)}},a1=class{constructor(H,C,V){this.element=H,this.type=6,this._$AN=void 0,this._$AM=C,this.options=V}get _$AU(){return this._$AM._$AU}_$AI(H){R(this,H)}},z1={M:O1,P:f,A:g1,C:1,L:G1,R:t1,D:I1,V:R,I:$,H:D,N:A1,U:o1,B:i1,F:a1},u2=h1.litHtmlPolyfillSupport;u2?.(j,$),(h1.litHtmlVersions??=[]).push("3.3.3");var K1=(M,H,C)=>{let V=C?.renderBefore??H,L=V._$litPart$;if(L===void 0){let r=C?.renderBefore??null;V._$litPart$=L=new $(H.insertBefore(K(),r),r,void 0,C??{})}return L._$AI(M),L};var y1=globalThis,u=class extends g{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let H=super.createRenderRoot();return this.renderOptions.renderBefore??=H.firstChild,H}update(H){let C=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(H),this._$Do=K1(C,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return k}};u._$litElement$=!0,u.finalized=!0,y1.litElementHydrateSupport?.({LitElement:u});var s2=y1.litElementPolyfillSupport;s2?.({LitElement:u});(y1.litElementVersions??=[]).push("4.2.2");var y=M=>(H,C)=>{C!==void 0?C.addInitializer(()=>{customElements.define(M,H)}):customElements.define(M,H)};var c2={attribute:!0,type:String,converter:G,reflect:!1,hasChanged:r1},h2=(M=c2,H,C)=>{let{kind:V,metadata:L}=C,r=globalThis.litPropertyMetadata.get(L);if(r===void 0&&globalThis.litPropertyMetadata.set(L,r=new Map),V==="setter"&&((M=Object.create(M)).wrapped=!0),r.set(C.name,M),V==="accessor"){let{name:e}=C;return{set(i){let t=H.get.call(this);H.set.call(this,i),this.requestUpdate(e,t,M,!0,i)},init(i){return i!==void 0&&this.C(e,void 0,M,i),i}}}if(V==="setter"){let{name:e}=C;return function(i){let t=this[e];H.call(this,i),this.requestUpdate(e,t,M,!0,i)}}throw Error("Unsupported decorator location: "+V)};function c(M){return(H,C)=>typeof C=="object"?h2(M,H,C):((V,L,r)=>{let e=L.hasOwnProperty(r);return L.constructor.createProperty(r,V),e?Object.getOwnPropertyDescriptor(L,r):void 0})(M,H,C)}function d(M){return c({...M,state:!0,attribute:!1})}var _=(M,H,C)=>(C.configurable=!0,C.enumerable=!0,Reflect.decorate&&typeof H!="object"&&Object.defineProperty(M,H,C),C);function d1(M,H){return(C,V,L)=>{let r=e=>e.renderRoot?.querySelector(M)??null;if(H){let{get:e,set:i}=typeof V=="object"?C:L??(()=>{let t=Symbol();return{get(){return this[t]},set(n){this[t]=n}}})();return _(C,V,{get(){let t=e.call(this);return t===void 0&&(t=r(this),(t!==null||this.hasUpdated)&&i.call(this,t)),t}})}return _(C,V,{get(){return r(this)}})}}var Y="scheduler_plus";async function q1(M){return(await M.callWS({type:`${Y}/list_schedules`})).schedules}async function j1(M,H){return(await M.callWS({type:`${Y}/create_schedule`,...H})).schedule}async function Y1(M,H,C){return(await M.callWS({type:`${Y}/update_schedule`,schedule_id:H,...C})).schedule}async function X1(M,H){await M.callWS({type:`${Y}/delete_schedule`,schedule_id:H})}async function J1(M){return M.callWS({type:`${Y}/get_preferences`})}var C2={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},p1=M=>(...H)=>({_$litDirective$:M,values:H}),N=class{constructor(H){}get _$AU(){return this._$AM._$AU}_$AT(H,C,V){this._$Ct=H,this._$AM=C,this._$Ci=V}_$AS(H,C){return this.update(H,C)}update(H,C){return this.render(...C)}};var{I:O2}=z1,H2=M=>M;var V2=()=>document.createComment(""),W=(M,H,C)=>{let V=M._$AA.parentNode,L=H===void 0?M._$AB:H._$AA;if(C===void 0){let r=V.insertBefore(V2(),L),e=V.insertBefore(V2(),L);C=new O2(r,e,M,M.options)}else{let r=C._$AB.nextSibling,e=C._$AM,i=e!==M;if(i){let t;C._$AQ?.(M),C._$AM=M,C._$AP!==void 0&&(t=M._$AU)!==e._$AU&&C._$AP(t)}if(r!==L||i){let t=C._$AA;for(;t!==r;){let n=H2(t).nextSibling;H2(V).insertBefore(t,L),t=n}}}return C},B=(M,H,C=M)=>(M._$AI(H,C),M),g2={},m1=(M,H=g2)=>M._$AH=H,L2=M=>M._$AH,v1=M=>{M._$AR(),M._$AA.remove()};var n1=p1(class extends N{constructor(){super(...arguments),this.key=p}render(M,H){return this.key=M,H}update(M,[H,C]){return H!==this.key&&(m1(M),this.key=H),C}});var M2=(M,H,C)=>{let V=new Map;for(let L=H;L<=C;L++)V.set(M[L],L);return V},x1=p1(class extends N{constructor(M){if(super(M),M.type!==C2.CHILD)throw Error("repeat() can only be used in text expressions")}dt(M,H,C){let V;C===void 0?C=H:H!==void 0&&(V=H);let L=[],r=[],e=0;for(let i of M)L[e]=V?V(i,e):e,r[e]=C(i,e),e++;return{values:r,keys:L}}render(M,H,C){return this.dt(M,H,C).values}update(M,[H,C,V]){let L=L2(M),{values:r,keys:e}=this.dt(H,C,V);if(!Array.isArray(L))return this.ut=e,r;let i=this.ut??=[],t=[],n,l,o=0,x=L.length-1,v=0,Z=r.length-1;for(;o<=x&&v<=Z;)if(L[o]===null)o++;else if(L[x]===null)x--;else if(i[o]===e[v])t[v]=B(L[o],r[v]),o++,v++;else if(i[x]===e[Z])t[Z]=B(L[x],r[Z]),x--,Z--;else if(i[o]===e[Z])t[Z]=B(L[o],r[Z]),W(M,t[Z+1],L[o]),o++,Z--;else if(i[x]===e[v])t[v]=B(L[x],r[v]),W(M,L[o],L[x]),x--,v++;else if(n===void 0&&(n=M2(e,v,Z),l=M2(i,o,x)),n.has(i[o]))if(n.has(i[x])){let h=l.get(e[v]),S1=h!==void 0?L[h]:null;if(S1===null){let B1=W(M,L[o]);B(B1,r[v]),t[v]=B1}else t[v]=B(S1,r[v]),W(M,L[o],S1),L[h]=null;v++}else v1(L[x]),x--;else v1(L[o]),o++;for(;v<=Z;){let h=W(M,t[Z+1]);B(h,r[v]),t[v++]=h}for(;o<=x;){let h=L[o++];h!==null&&v1(h)}return this.ut=e,m1(M,t),k}});var X=["light","climate","switch"],l1={light:"Light",climate:"Climate",switch:"Switch"},r2=["fixed","sunrise","sunset"],J={fixed:"Fixed time",sunrise:"Sunrise",sunset:"Sunset",yidcal:"YidCal"},b=["mon","tue","wed","thu","fri","sat","sun"],Z1={mon:"Monday",tue:"Tuesday",wed:"Wednesday",thu:"Thursday",fri:"Friday",sat:"Saturday",sun:"Sunday"},e2=["always","include","exclude"],t2={always:"Always",include:"Only on these dates",exclude:"Except these dates"},i2=["shabbos","yom_tov","erev_shabbos","erev_yom_tov"],C1={shabbos:"Shabbos",yom_tov:"Yom Tov",erev_shabbos:"Erev Shabbos",erev_yom_tov:"Erev Yom Tov"};var E=class extends u{constructor(){super(...arguments);this._handleTitleChange=C=>{let V=C.target.value;this._fireConfigChanged({...this._config,title:V||void 0})};this._addEntity=C=>{!C||this._entities.includes(C)||this._fireConfigChanged({...this._config,entities:[...this._entities,C]})};this._updateEntity=(C,V)=>{if(!V){this._removeEntity(C);return}let L=this._entities.map((r,e)=>e===C?V:r);this._fireConfigChanged({...this._config,entities:L})};this._removeEntity=C=>{let V=this._entities.filter((L,r)=>r!==C);this._fireConfigChanged({...this._config,entities:V})}}setConfig(C){this._config=C}_fireConfigChanged(C){this._config=C,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:C}}))}get _entities(){return this._config?.entities??[]}render(){return this._config?a`
  ...
  `,A([c({attribute:!1})],m.prototype,"hass",2),A([d()],m.prototype,"_open",2),A([d()],m.prototype,"_preferences",2),A([d()],m.prototype,"_deviceType",2),A([d()],m.prototype,"_name",2),A([d()],m.prototype,"_enabled",2),A([d()],m.prototype,"_days",2),A([d()],m.prototype,"_dateMode",2),A([d()],m.prototype,"_dates",2),A([d()],m.prototype,"_newDate",2),A([d()],m.prototype,"_dateRanges",2),A([d()],m.prototype,"_newRangeStart",2),A([d()],m.prototype,"_newRangeEnd",2),A([d()],m.prototype,"_dayConditions",2),A([d()],m.prototype,"_onTime",2),A([d()],m.prototype,"_offTime",2),A([d()],m.prototype,"_setBrightness",2),A([d()],m.prototype,"_brightnessPct",2),A([d()],m.prototype,"_useTransition",2),A([d()],m.prototype,"_transitionSeconds",2),A([d()],m.prototype,"_hvacMode",2),A([d()],m.prototype,"_useTargetTemperature",2),A([d()],m.prototype,"_targetTemperature",2),A([d()],m.prototype,"_error",2),m=A([y("scheduler-plus-rule-editor")],m);function B2(M){let[H,C]=M.split(":"),V=Number(H),L=Number(C),r=V>=12?"PM":"AM";return`${V%12===0?12:V%12}:${L.toString().padStart(2,"0")} ${r}`}function A2(M){if(M.provider==="fixed")return B2(M.params.time??"00:00");let H=M.params.offset_minutes??0;return H===0?J[M.provider]:`${J[M.provider]} ${H>0?"+":""}${H}`}var S=class extends u{constructor(){super(...arguments);this._open=!1;this._name="";this._deviceType="light";this._enabled=!0;this._entities=[];this._rules=[];this._saving=!1;this._closeDialog=()=>{this._open=!1};this._handleDeviceTypeChange=C=>{this._deviceType=C.target.value,this._entities=[],this._rules=[]};this._addEntity=C=>{!C||this._entities.includes(C)||(this._entities=[...this._entities,C])};this._removeEntity=C=>{this._entities=this._entities.filter((V,L)=>L!==C)};this._updateEntity=(C,V)=>{if(!V){this._removeEntity(C);return}this._entities=this._entities.map((L,r)=>r===C?V:L)};this._openAddRuleDialog=()=>{this._ruleEditor?.showDialog({deviceType:this._deviceType,onSave:C=>{this._rules=[...this._rules,C]}})};this._openEditRuleDialog=C=>{this._ruleEditor?.showDialog({deviceType:this._deviceType,rule:this._rules[C],onSave:V=>{this._rules=this._rules.map((L,r)=>r===C?V:L)}})};this._removeRule=C=>{let V=this._rules[C];!V||!window.confirm(`Delete rule "${V.name}"?`)||(this._rules=this._rules.filter((L,r)=>r!==C))};this._save=async()=>{let C=this._name.trim();if(!C){this._error="Name is required.";return}if(this._entities.length===0){this._error="At least one entity is required.";return}this._saving=!0,this._error=void 0;try{let V={name:C,device_type:this._deviceType,entities:this._entities,enabled:this._enabled,rules:this._rules};this._schedule?await Y1(this.hass,this._schedule.id,V):await j1(this.hass,V),this._open=!1,this.dispatchEvent(new CustomEvent("schedule-plus-saved"))}catch(V){this._error=V instanceof Error?V.message:String(V)}finally{this._saving=!1}}}showDialog(C){this._schedule=C,this._name=C?.name??"",this._deviceType=C?.device_type??"light",this._enabled=C?.enabled??!0,this._entities=C?[...C.entities]:[],this._rules=C?C.rules.map(V=>({...V})):[],this._error=void 0,this._open=!0}render(){return this._open?a`
      <ha-dialog open @closed=${this._closeDialog}>
        <div class="form">
          ...
          >
            ${X.map(C=>a`<option value=${C}>${l1[C]}</option>`)}
          </select>
    ...
    `:p}_renderRule(C,V){let L=[...C.days].sort((i,t)=>b.indexOf(i)-b.indexOf(t)).map(i=>Z1[i].slice(0,3)).join(", "),r=[...C.dates.length>0?[`${C.dates.length} date${C.dates.length===1?"":"s"}`]:[],...C.date_ranges.length>0?[`${C.date_ranges.length} range${C.date_ranges.length===1?"":"s"}`]:[],...C.day_conditions.map(i=>C1[i])],e=r.length===0?"":C.date_mode==="exclude"?` \xB7 except ${r.join(", ")}`:C.date_mode==="include"?` \xB7 only ${r.join(", ")}`:"";return a`
  ...
  `,A([c({attribute:!1})],S.prototype,"hass",2),A([d()],S.prototype,"_schedule",2),A([d()],S.prototype,"_open",2),A([d()],S.prototype,"_name",2),A([d()],S.prototype,"_deviceType",2),A([d()],S.prototype,"_enabled",2),A([d()],S.prototype,"_entities",2),A([d()],S.prototype,"_rules",2),A([d()],S.prototype,"_saving",2),A([d()],S.prototype,"_error",2),A([d1("scheduler-plus-rule-editor")],S.prototype,"_ruleEditor",2),S=A([y("scheduler-plus-schedule-editor")],S);function b2(M){if(!M.next_event)return;let H=new Date(M.next_event);if(Number.isNaN(H.getTime()))return;let C=M.next_event_action==="off"?"Off":"On",V=H.toLocaleString(void 0,{weekday:"short",hour:"numeric",minute:"2-digit"});return`Next: ${C} ${V}`}var T2="#F2A93B",s=class extends u{constructor(){super(...arguments);this._schedules=[];this._loading=!0;this._openAddDialog=()=>{this._editor?.showDialog()};this._openEditDialog=C=>{this._editor?.showDialog(C)}}static getStubConfig(){return{type:"custom:scheduler-plus-card"}}static getConfigElement(){return document.createElement("scheduler-plus-card-editor")}setConfig(C){this._config=C}getCardSize(){return 2+this._visibleSchedules.length}get _visibleSchedules(){let C=this._config?.entities;return!C||C.length===0?this._schedules:this._schedules.filter(V=>V.entities.some(L=>C.includes(L)))}connectedCallback(){super.connectedCallback(),this._refresh()}async _refresh(){this._loading=!0;try{this._schedules=await q1(this.hass),this._error=void 0}catch(C){this._error=C instanceof Error?C.message:String(C)}finally{this._loading=!1}}async _handleDelete(C){window.confirm(`Delete schedule "${C.name}"?`)&&(await X1(this.hass,C.id),await this._refresh())}render(){return a`
      <ha-card>
        <div class="header">
  ...
  `,A([c({attribute:!1})],s.prototype,"hass",2),A([d()],s.prototype,"_config",2),A([d()],s.prototype,"_schedules",2),A([d()],s.prototype,"_loading",2),A([d()],s.prototype,"_error",2),A([d1("scheduler-plus-schedule-editor")],s.prototype,"_editor",2),s=A([y("scheduler-plus-card")],s);window.customCards=window.customCards??[];window.customCards.push({type:"scheduler-plus-card",name:"Scheduler+",description:"Visual scheduling for lights and climate devices."});export{s as SchedulerPlusCard};
